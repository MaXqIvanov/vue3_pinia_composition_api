  ...
  <div class="sidebar_boxes">
    <div class="sidebar_boxes__block">
      <div
        ...
        @click="boxStore.setCurrentBox(null, null)"
      />
      <div class="sidebar_boxes__box">
        <div
          :style="{ backgroundColor: boxStore.current_box?.color }"
          class="box__color"
        >
          <div
            :style="{ backgroundColor: boxStore.current_box?.color_blur }"
      ...
      <div class="sidebar_boxes__body">
        <div class="shadow_block sidebar_boxes__shadow_block" />
        <div class="shadow_block sidebar_boxes__shadow_block" />
        <div class="shadow_block sidebar_boxes__shadow_block" />
        <div class="shadow_block sidebar_boxes__shadow_block" />
      </div>
      <div class="sidebar_boxes__footer">
        <input
          ...
          :defaultValue="
            boxStore.current_box !== null && boxStore.current_box.count
          "
          @input="boxStore.changeCountBoxes"
        >
        <Button
          v-if="!is_approve_delete"
          :text-color="'white'"
          :background-color="'#FA7272'"
          :title="'Удалить предмет'"
          :style="{ padding: '1vw 5vw', whiteSpace: 'nowrap' }"
          @click="is_approve_delete = !is_approve_delete"
        />
        <div
          v-else
          class="group_btn"
        >
          ...
          <Button
            ...
            :background-color="'#FA7272'"
            :title="'Подтвердить'"
            :style="{ padding: '1vw 1.5vw', whiteSpace: 'nowrap' }"
            @click="boxStore.deleteBox"
          />
        </div>
      </div>
    </div>
...
const is_approve_delete = ref(false);
</script>
